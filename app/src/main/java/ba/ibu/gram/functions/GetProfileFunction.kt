...
class GetProfileFunction @Inject constructor() : BaseFunction<UnitModel, User>() {
  override suspend fun call(input: UnitModel): User? {
    return callFunction("getProfile", input)
  }
